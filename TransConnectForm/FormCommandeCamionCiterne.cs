...
{
    internal partial class FormCommandeCamionCiterne : Form
    {
        ...
        private CamionCiterne vehicule;
        private CheminRoutier route;
        private Commandes commandes;
        public FormCommandeCamionCiterne(FormNouvelleCommande predecesseur, Client client, Salarie chauffeur, CamionCiterne vehicule, DateTime date, Commandes commandes)
        {
            ...
            lbl_TypeFluide.Text = vehicule.TypeDeCuve;
            lbl_Volume.Text = Convert.ToString(vehicule.Volume) + " L";
        }
        ...
        private void btn_NouvelleCommande_Click(object sender, EventArgs e)
        {
            ...
            else if (cbBox_PointA.Text == cbBox_PointB.Text)
            {
                MessageBox.Show("Veuillez sélectionner un point de départ différent du point d'arrivée");
            }
            else
            {
