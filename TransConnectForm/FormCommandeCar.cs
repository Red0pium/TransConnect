...
{
    internal partial class FormCommandeCar : Form
    {
        ...
        public FormCommandeCar(FormNouvelleCommande predecesseur, Client client, Salarie chauffeur, Car vehicule, DateTime date, Commandes commandes)
        {
            ...
            lbl_NombrePassager.Text = Convert.ToString(vehicule.NombrePassager);
        }
