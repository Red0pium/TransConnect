...
{
    internal partial class FormCommandeCamionFrigorifique : Form
    {
        ...
        private CamionFrigorifique vehicule;
        private CheminRoutier route;
        private Commandes commandes;
        public FormCommandeCamionFrigorifique(FormNouvelleCommande predecesseur, Client client, Salarie chauffeur, CamionFrigorifique vehicule, DateTime date, Commandes commandes)
        {
